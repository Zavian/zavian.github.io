...
var BBCodeHTML = function() {
    ...
    me.bbCodes = [{
            code: 'b',
            pattern: '[b]{TEXT}[/b]',
            replacer: '<strong>{TEXT}</strong>',
            explanation: 'Makes <strong>bold</strong> text.'
        },
        {
            code: 'i',
            pattern: '[i]{TEXT}[/i]',
            replacer: '<em>{TEXT}</em>',
            explanation: 'Makes the text <em>italic</em>.'
        },
        {
            code: 'u',
            pattern: '[u]{TEXT}[/u]',
            replacer: '<span style="text-decoration:underline;">{TEXT}</span>',
            explanation: '<span style="text-decoration:underline;">Underlines</span> the text.'
        },
        {
            code: 's',
            pattern: '[s]{TEXT}[/s]',
            replacer: '<span style="text-decoration:line-through;">{TEXT}</span>',
            explanation: '<span style="text-decoration:line-through;">Strikes</span> through the text.'
        },
        {
            code: 'color',
            pattern: '[color={COLOR}]{TEXT}[/color]',
            replacer: '<span style="color: {COLOR}">{TEXT}</span>',
            explanation: '<span style="color: red">Colors</span> the text the specified color (supports both color names and hex values starting with "#").'
        },
        {
            code: 'highlight',
            pattern: '[highlight={COLOR}]{TEXT}[/highlight]',
            replacer: '<span style="background-color:{COLOR}">{TEXT}</span>',
            explanation: '<span style="background-color:red">Highlights</span> the text the specified color (supports both color names and hex values starting with "#").'
        },
        {
            code: 'center',
            pattern: '[center]{TEXT}[/center]',
            replacer: '<p style="text-align: center;">{TEXT}</p>',
            explanation: '<p style="text-align: center;">Centers the text.</p>'
        },
        {
            code: 'justify',
            pattern: '[justify]{TEXT}[/justify]',
            replacer: '<p style="text-align: justify;">{TEXT}</p>',
            explanation: '<p style="text-align: justify;">Justifies the text.</p>'
        },
        {
            code: 'right',
            pattern: '[right]{TEXT}[/right]',
    ...
    me.bbCodes.forEach((code) => {
        me.addBBCode(code.pattern, code.replacer);
    });
    ...
    //me.addBBCode('[justify]{TEXT}[/justify]', '<p style="text-align: justify;">{TEXT}</p>');
    //me.addBBCode('[right]{TEXT}[/right]', '<p style="text-align: right;">{TEXT}</p>');
};
